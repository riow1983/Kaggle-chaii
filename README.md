...
|-|--max_length 512 --doc_stride 80 --num_train_epochs 1|0.650|0.719|
<br>
...
|k2lnb001-chaii-eda-baseline-train|-|./input/hf-datasets, ./input/xlm-roberta-squad2|./notebooks/k2lnb001-chaii-eda-baseline-train/chaii-bert-trained, ./notebooks/k2lnb001-chaii-eda-baseline-train/chaii-qa, ./notebooks/k2lnb001-chaii-eda-baseline-train/runs|作成中|[ChAII - EDA & Baseline](https://www.kaggle.com/riow1983/chaii-eda-baseline)からinference部分を除外したもの|
|kagglenb003-chaii-eda-baseline-inference|-|[thedrcat/hf-datasets](https://www.kaggle.com/thedrcat/hf-datasets), [nbroad/xlm-roberta-squad2](https://www.kaggle.com/nbroad/xlm-roberta-squad2), riow1983/k2lnb001-chaii-eda-baseline-train|submission.csv|未作成|[ChAII - EDA & Baseline](https://www.kaggle.com/riow1983/chaii-eda-baseline)からtrain部分を除外したもの|
<br>
